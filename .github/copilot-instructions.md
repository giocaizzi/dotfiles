...
- [`run_after_11-sync-copilot-agents.sh`](./.chezmoiscripts/run_after_11-sync-copilot-agents.sh.tmpl): Sync the Copilot agents from vscode-ralph repository on every chezmoi apply (excludes README).
