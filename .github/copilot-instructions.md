...
- [`run_after_11-sync-copilot-agents.sh`](./.chezmoiscripts/run_after_11-sync-copilot-agents.sh.tmpl): Sync Copilot agent repositories on every chezmoi apply (currently ralph-copilot; supports multiple repos).
